      ...
      <div className="flex flex-col space-y-5 2xl:space-y-10 mt-[9vh]">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            <ArrowSmallRightIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">https://twitter.com/hashq_</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <ArrowSmallRightIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">
              https://www.linkedin.com/in/hasham-qaiser/
            </p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">hashamqaiser24@gmail.com</p>
          </div>
        </div>
        <form
